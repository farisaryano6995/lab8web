...
![Hasil](img/folder.png)

1. Kemudian untuk mengakses direktory tersebut pada web server dengan mengakses URL: 
http://localhost/lab8_php
![Hasil](img/crud.png)
...
?>
```
* atau bisa menggunakan code simple
```
<?php
...
?>
```
3. Buka melalui browser untuk menguji koneksi database (untuk menyampilkan pesan 
koneksi berhasil, uncomment pada perintah echo “koneksi berhasil”;
![Hasil](img/berhasil.png)
